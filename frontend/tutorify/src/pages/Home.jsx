  ...
  const testimonials = [
    {
      ...
      text: "Tutorify saved my calculus grade! I was struggling with derivatives, but my tutor broke everything down in a way that finally made sense.",
    },
    {
      name: 'Maya Johnson',
      role: 'High School Student',
      image: '/api/placeholder/100/100',
      text: "I went from a C to an A in physics thanks to my Tutorify tutor. The on-demand help when I'm stuck on homework is a game-changer!",
    },
    {
      name: 'David Park',
      role: 'Parent',
      image: '/api/placeholder/100/100',
      text: "As a busy parent, I love that my daughter can get expert help instantly. The quality of tutors and the flexible scheduling makes Tutorify worth every penny.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="px-4 py-2 rounded-3xl text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 transform hover:scale-105 transition-all duration-300 hover: cursor-pointer">
                Get Started !
              </button>
            </div>
          </div>
...
export default TutorifyLandingPage;