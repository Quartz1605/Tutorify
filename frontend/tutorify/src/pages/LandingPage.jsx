...
const LandingPage = () => {
  ...
  function openSideBar() {
    document.getElementById("sidebar").classList.remove("right-[-600px]")
  ...
  function closeSidebar() {
    ...
    document.getElementById("sidebar").classList.add("right-[-600px]")
  }
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-amber-50 to-blue-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="px-6 py-2 rounded-3xl text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 transform hover:scale-105 transition-all duration-300 hover: cursor-pointer" onClick={openSideBar}>
                Get Started !
              </button>
            </div>
          </div>
      ...
      <div id="sidebar" className="fixed top-0 right-[-600px] w-150 h-full text-white p-5 shadow-lg transition-all duration-300 z-60 backdrop-blur-xl">
        ...
        <button className="bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 justify-center text-center mt-7 py-4 px-8 rounded-xl text-white font-bold ml-55 hover:cursor-pointer" onClick={sendOTP}>
          Login !
        </button>
