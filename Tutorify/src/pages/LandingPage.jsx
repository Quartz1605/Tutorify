  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-amber-50 to-blue-500">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 w-32 h-32 bg-[#4b48fa] rounded-lg opacity-10 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-40 h-40 bg-green-400 rounded-full opacity-10 animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/5 w-36 h-36 bg-blue-400 rounded-full opacity-10 animate-pulse"
        ...
        <div
          ...
          style={{
            ...
            top: mousePosY - 128,
            transform: `translate(${
              (mousePosX - window.innerWidth / 2) * -0.02
            }px, ${(mousePosY - window.innerHeight / 2) * -0.02}px)`,
          }}
        ></div>
      </div>
      ...
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-1000 backdrop-blur-md ${
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8">
                <a
                  href="#"
                  className="text-blue-800 hover:text-white transition-colors duration-300"
                >
                  How It Works
                </a>
                <a
            ...
            <div className="flex items-center space-x-4">
              <Link to="/register/">
                <button className="px-6 py-2 rounded-xl text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 transform hover:scale-105 transition-all duration-300 hover: cursor-pointer">
                  Get Started !
                </button>
              </Link>
      ...
      <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28 flex items-center justify-center min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <div
              className={`transition-all duration-1000 max-w-3xl ${
                isLoaded ? "opacity-100" : "opacity-0 -translate-y-10"
              }`}
            >
              ...
              <div className="mt-10 flex justify-center space-x-4">
                <button className="px-8 py-4 rounded-lg text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 font-bold shadow-lg hover:shadow-blue-500/20 transform hover:scale-105 transition-all duration-300">
                  Book A Tutor Now
                </button>
              </div>
            </div>
            ...
            {[
              {
                ...
                description:
                  "Browse our network of expert tutors or get instantly matched with the perfect tutor for your subject and learning style.",
              },
              {
                icon: "📅",
                title: "Schedule a Session",
                description:
                  "Book an immediate session or schedule for later. Our tutors are available 24/7, ready to help whenever you need it.",
              },
              {
                icon: "🚀",
                title: "Learn & Succeed",
                description:
                  "Connect via our interactive learning platform. Share documents, collaborate on problems, and ace your coursework.",
              },
            ].map((step, index) => (
              <div
                key={index}
                className={`bg-white/5 backdrop-blur-sm rounded-xl p-8 transform hover:scale-105 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            {subjects.map((subject, index) => (
              <div
                key={index}
                className={`bg-white/5 backdrop-blur-sm rounded-xl p-6 transform hover:scale-105 hover:bg-white/10 transition-all duration-300 cursor-pointer ${
                  isLoaded ? "opacity-100" : "opacity-0"
                }`}
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-white mb-8">
                Join thousands of students already using Tutorify to achieve
                their academic goals, master difficult subjects, and boost their
                confidence.
              </p>
              <div className="sm:flex sm:space-x-4">
                <button className="w-full sm:w-auto mb-4 sm:mb-0 px-8 py-4 rounded-lg bg-white text-blue-600 font-bold shadow-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-xl p-4 shadow-xl transform hover:-rotate-3 transition-all duration-500 hover:cursor-pointer">
                <div className="flex items-center">
                  <div className="flex -space-x-2 mr-4">
                    <div className="h-10 w-10 rounded-full bg-green-500 flex items-center justify-center text-white text-xs">
                      A+
                    </div>
                  </div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700">
            <p className="text-white text-center">
              © 2025 Tutorify, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          ...
          >
            ...
            <div className="mt-8">
              <button className="w-full py-3 px-4 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold hover:from-pink-600 hover:to-purple-600 transition-all duration-300">
                Find Tutors Now
              </button>
